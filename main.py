...
def btClick():
    if signal and template:
        signal_p = Path('/Users/ajishat/Downloads/mini project/signal.txt')
        template_p= Path('/Users/ajishat/Downloads/mini project/template.txt')
    if signal_p is not None and template_p is not None:
        cycle_cutting(signal_p,template_p)
